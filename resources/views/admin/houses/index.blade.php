        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Houses')</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('All Houses')</h3>
                        <div class="card-tools">
                            <a href="{{route('admin.houses.add')}}" class="btn btn-success">
...
<form action="{{route('admin.houses.delete')}}" method="post" class="modal fade" id="delete-modal">
    @csrf
...
<script type="text/javascript">
   ...
   let entitiesDataTable = $('#entities-list-table').DataTable({
        ...
        "processing": true,
        "ajax": {
            "url": "{{route('admin.houses.datatable')}}",
            "type": "post",
            "data": {
                "_token": "{{csrf_token()}}"
            }
...
//
//            if (xhr.responseJSON && xhr.reponseJSON['system_error']) {
//                systemError = xhr.reponseJSON['system_error'];
//            }
